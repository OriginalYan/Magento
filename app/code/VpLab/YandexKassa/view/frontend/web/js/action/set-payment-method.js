define(
    [
        ...
        'VpLab_YandexKassa/js/form/form-builder',
        'VpLab_YandexKassa/js/form/direct'
    ],
    function ($, quote, customerData, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, formBuilder, direct) {
        ...
        return function (messageContainer) {
            ...
            console.log(window.checkoutConfig.payment.vplab_yandex);

            serviceUrl = window.checkoutConfig.payment.vplab_yandex.redirectUrl+'?email='+email;
