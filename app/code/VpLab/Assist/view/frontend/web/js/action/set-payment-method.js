define(
    [
        ...
        'VpLab_Assist/js/form/form-builder',
        'VpLab_Assist/js/form/direct'
    ],
    function ($, quote, customerData, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, formBuilder, direct) {
        ...
        return function (messageContainer) {
            ...
            console.log(window.checkoutConfig.payment.vplab_assist);

            serviceUrl = window.checkoutConfig.payment.vplab_assist.redirectUrl+'?email='+email;
