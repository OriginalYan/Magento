...
namespace Zitec\Dpd\Block\Order\Creditmemo\Totals;

use Zitec\Dpd\Block\Order\Totals\Cashondeliverysurchage;
 ...
 */
class Cashondeliverysurcharge extends Cashondeliverysurchage
{
    /**
     *
     * @return float
